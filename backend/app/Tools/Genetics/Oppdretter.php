...
class Oppdretter
{
    ...
    public static $antal_rogn_per_smolt;
    ...
    public static function setInputs(
        ...
        self::$antal_rogn_per_smolt = $antal_rogn_per_smolt;
    ...
    public static function antallRognPerSmolt()
    {
        return self::$antal_rogn_per_smolt;
    }
    ...
    private static function oktSlaktevektGram()
    {
        ...
        return (EM::snittvektRund() - self::$oktSlaktevektGramValue[1]) * 1000;
    }
    ...
    public static function output(ToolsOutputInterface $toolsOutput)
    {
        $outputData = array(
            ...
            'pdf' => array(
                ...
                'redusertBFCRPercentage' => number_format((self::redusertBFCRPercentage()), 2, '.', ' '),
     ...
     */
    public static function getCaseNo()
    {
        return self::$case_no;
    }
