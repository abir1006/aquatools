...
use App\Tools\Vaccine\Calculation;
use App\Tools\Vaccine\Oppdretter;
use Illuminate\Http\Request;

class VaccineModelController extends Controller
{
    ...
    public function calculation(Request $request)
    {
        ...
        $prod_kost_budsjett = $request['vaksinering_produksjonsmodell_prod_kost_budsjett_case1'];
        ...
        $budsjett_smolt_pris_nok_per_stk = $request['vaksinering_grunnforutsetninger_budsjett_smolt_pris_nok_per_stk_case1'];
        $budsjett_utkast = $request['vaksinering_grunnforutsetninger_budsjett_utkast_case1'];
        $budsjett_cv = $request['vaksinering_grunnforutsetninger_budsjett_cv_case1'];
        ...
        $prevalens_percentage = $request['vaksinering_effekter_sjukdom_sannsynlighet_for_sjukdom_case1'];
        $sjukdom_kt_cv = $request['vaksinering_effekter_sjukdom_kt_cv_case1'];
        ...
        for ($case_no = 1; $case_no <= $total_cases; $case_no++) {
            if ($case_no >= 3) {
                ...
                $vaksine_sannsynlighet_for_sjukdom_rpp = $request['vaksinering_effekter_sjukdom_sannsynlighet_for_sjukdom_case1'];
                $vaksine_cv_rpp = $request['vaksinering_effekter_av_vaksine_cv_rpp_case' . $case_no];
                $vaksine_cv_bi_effekt = $request['vaksinering_effekter_av_vaksine_cv_bi_effekt_case' . $case_no];
            } else {
            ...
            $laksepris_em = $request['vaksinering_produksjonsmodell_laksepris_case' . $case_no];
            ...
            $output['case' . $case_no] = Oppdretter::output(new FeedArrayOutput());
