...
import { SSOLogout } from '../../Store/Actions/authActions';
...
const ConfirmPopup = props => {
    ...
    const confirmOperation = async () => {
        ...
        if (props.popup.confirmItemName === 'navigation_prompt') {
            if (Boolean(props.popup.isDirty) && (props.popup.confirmItemId.pathname === "/admin/login"))
                await props.SSOLogout();
        ...
        if (props.popup.confirmItemName === 'template update') {
            ...
            axios.put('api/template/update', {
                ...
                template_data: props.modelScreenInputs
            }, {
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
