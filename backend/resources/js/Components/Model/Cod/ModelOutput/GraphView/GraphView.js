            ...
            <div id="graph-wrapper" style={{ height: graphWrapperHeight }}>
                {
                    Object.keys(graphData).map(index => {
                        if (index === 'nytteKostRatio1' || index === 'nytteKostRatio2' || index === 'biologiskeTap' || index === 'okteUtgifter') {
                            return null;
                        }
                        let countBarCell = -1;
                        countGraph++;
                            ...
                            <div className="graph-plot">
                                <ResponsiveContainer width="100%" height={graphColHeight}>
                                    <BarChart
                                        ...
                                        <Bar dataKey="biologiskeTap" isAnimationActive={false} barSize={barSize} stackId=""
                                            minPointSize={5}>
                                            <LabelList
                                        ...
                                        <Bar dataKey="okteUtgifter" isAnimationActive={false} barSize={barSize} stackId=""
