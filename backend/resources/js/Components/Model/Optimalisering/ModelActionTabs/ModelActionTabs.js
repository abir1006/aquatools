...
class ModelActionTabs extends Component {
    ...
    async addNewCaseHandler() {
        ...
        await this.props.setOptModelResult(this.props.inputs, this.props.caseNumbers);
    ...
    removeCaseHandler() {
        ...
        this.props.setOptModelResult(this.props.inputs, this.props.caseNumbers);
    }
    ...
    resetToCase1Handler() {
        ...
        this.props.setOptModelResult(resetInputs, this.props.caseNumbers);
    }
            ...
            <div className="section-block model-action-tabs">
                ...
                <div className="float-right mt-0 mt-xl-0 mt-lg-2 mt-md-2">
                    <ActionButton
                        ...
                        {t('reset')} {this.props.screenSize >= 768 && t('to_case1')}
                    </ActionButton>
                    <ActionButton
