            ...
            <table className="table table-borderless table-striped">
                <thead>
                    <tr>
                        ...
                        <th scope="col">{t('benefit_cost_ratio')} 2</th>
                    </tr>
                </thead>
                <tbody>
                    {
                        Object.keys(blockOutput).map(objKey => {
                            ...
                            return (
                                <tr key={countBlockOutput}>
                                    ...
                                    <td>{parseFloat(blockOutput[objKey].nytteKostRatio2) !== 0.0 && number_format(blockOutput[objKey].nytteKostRatio2.toFixed(1), 1, '.', ' ')}</td>
                                </tr>
                            )
                        })
                    }
