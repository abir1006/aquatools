...
<div id="pdf_frame">
    <div class="pdf_body">
        ...
        $gpmBaseValue = $graphBaseValue['grossProfitMargin'];
        ...
        foreach ($caseNumbers as $case) {
            ...
            $gpm_values[] = $gpm_value = $graphResult['grossProfitMargin']['Case' . $case];
            $gpmDataStr .= $gpm_value . ',';
        }
        ...
        $gpm_chart = PDFController::drawBarChart($caseStr, $gpmDataStr, $gpmBaseValue);
        ...
        <div class="model_table_view" style="width: 100%">
                        ...
                        <div class="data-block" style="width: 100%">
                            ...
                            <div class="data_row">
                                ...
                                <div class="data_column">
                                    {{ number_format($inputs['genetics_produksjonsmodell_antall_smolt_case1'], 0, '.', ' ') }}
                                </div>
                            </div>
                            <div class="data_row">
                            ...
                            <div class="data_row">
                                ...
                                <div class="data_column">
                                    {{ $inputs['genetics_produksjonsmodell_laksepris_case1'] }}</div>

                            </div>


                            <div class="data_row">
                                <div class="data_column">{{__('number_of_eggs_per_smolt')}}</div>

                                <div class="data_column">
                                    {{ $inputs['genetics_grunnforutsetninger_antall_rogn_per_smolt_case1'] }}
                                </div>
                    ...
                    <td style="width: 100%;text-align:left">
                        ...
                        <div style="background-color: white;padding: 5px">
                            <table style="width: 100%" class="resultant-production vaccine-table">
                                <thead>
                                <tr>
                                    <th style="text-align: left">{{ strtoupper(__('effects_improved_production'))}}</th>
                                    @foreach ($caseNumbers as $case)
                                        <th>
                                ...
                                <tbody>
                                <tr class="data_row">
                                    <td>{{__('increased_growth_grams')}}</td>
                                    @foreach ($caseNumbers as $case)
                                        <td>
                                ...
                                <tr class="data_row">
                                    <td>{{__('average_weight_of_reduced_mortality_kg')}}</td>
                                    @foreach ($caseNumbers as $case)
                                ...
                                <tr class="data_row">
                                    <td>{{__('reduced_prod_cost_per_kg')}}</td>
                                    @foreach ($caseNumbers as $case)

                                        <td>
                                            {{$case == 1 ? '': $inputs['genetics_effekter_genetikk_reduksjon_prodkost_per_kg_case'.$case]}}
                                        </td>
            ...
            <div style="background-color: white;padding: 5px">
                <table style="width: 100%" class="resultant-production vaccine-table">
                    ...
                    <tr class="data_row">
                        <td>{{__('extra_genetics_cost_per_egg')}}</td>
                        @foreach ($caseNumbers as $case)
                    ...
                    <tr class="data_row">
                        <td>{{__('extra_cost_increased_egg_price_total')}}</td>
                        @foreach ($caseNumbers as $case)
                            <td>
                    ...
                    <tr class="data_row">
                        <td>{{__('more_slaughtered_genetics_kg')}}</td>
                        @foreach ($caseNumbers as $case)
