...
class GraphView extends Component {
    ...
    render() {
        ...
        // New C/B Ratio graph
        // let newNKR = [{BCR: 0, label: t('case') + '1', label2: "BCR"}];
        // let nkrCount = 0;
        ...
        return (
            <div id="graph-wrapper" style={{height: graphWrapperHeight}}>
                                ...
                                <div className="content-block">
                                    <div className="graph-content" id={'graph-block-'+(keyNumber)}>
                                        <h5 className="output-heading">{t(this.props.graphOutputLabel[index])}
                                            {
                                                Boolean(this.props.genGraphHelpText[index]) && <button
                                                    type="button"
                                                    id={'help-text-id-' + (keyNumber)}
                                                    className="btn btn-primary-outline at2-btn-no-bg at2-info-icon-btn"
                                                    onClick={e => this.viewHelpTextHandler(e, t(this.props.genGraphHelpText[index]), 'graph-block-'+(keyNumber))}>
                                                    i
                                                </button>
                                            }</h5>
                ...
                {/*                {*/}
                {/*                    Boolean(this.props.genGraphHelpText['bcr']) && <button*/}
                {/*                        type="button"*/}
                {/*                        id={'help-text-id-1'}*/}
                {/*                        className="btn btn-primary-outline at2-btn-no-bg at2-info-icon-btn"*/}
...
const mapStateToProps = state => ({
    ...
    genGraphHelpText: state.modelScreen.graphHelpText,
});
